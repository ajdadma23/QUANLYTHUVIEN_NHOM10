...
public class NhanvienData {
    ...
    public static ArrayList<Nhanvien> getListnv() {
        ...
        try {
            ...
            Nhanvien nv;
            while (rs.next()) {
                nv = new Nhanvien(rs.getString("Ma_Nhan_vien"), rs.getString("Ten_Nhan_vien"), rs.getDate("Ngay_sinh"), rs.getString("Dia_chi"), rs.getString("So_dien_thoai"));
                ListNV.add(nv);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static ArrayList<Nhanvien> addStaff(String manv) {
        ...
        try {
            ps = (PreparedStatement) Connect.getConnect().prepareStatement("INSERT INTO `nhan_vien`"
                    + "(`Ma_Nhan_vien`, `Ten_Nhan_vien`, `Ngay_sinh`, `Dia_chi`, `So_dien_thoai`)"
